...
print(env)
# Read .env if it exists, otherwise fallback to .env.example
...
SECRET_KEY = env.str('SECRET_KEY', 'django-insecure-dk0m3h38&+&aqz)shhw$=^8*-!m)uav9=ee(7v7w!emzrxgw^3')
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'drf_spectacular',
    # Local Apps- Pointing directly to the AppConfig classes
    'apps.common',
    'apps.agent',
]
...
# Customize the text on the Swagger page
SPECTACULAR_SETTINGS = {
    'TITLE': 'CodeFusion AI API',
    'DESCRIPTION': 'API documentation for the autonomous codebase research agent.',
    'VERSION': '1.0.0',
